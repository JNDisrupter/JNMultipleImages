...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://EXAMPLEs/JNMultipleImages"
  ...
  s.author             = { "JNDisrupter"}
  # Or just: s.author    = "mohammadnabulsi"
  # s.authors            = { "mohammadnabulsi" => "mohammad.s.nabulsi@gmail.com" }
  # s.social_media_url   = "http://twitter.com/mohammadnabulsi"
  ...
  s.source       = { :git => "http://EXAsMPLE/JNMultipleImages.git", :tag => "#{s.version}" }
