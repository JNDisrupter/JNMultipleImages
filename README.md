...
JNMultipleImages support SwiftPM. To use SwiftPM, you should use Xcode 15.3 to open your project. Click `File` -> `Swift Packages` -> `Add Package Dependency`, enter [JNMultipleImages repo's URL](https://github.com/JNDisrupter/JNMultipleImages.git)
